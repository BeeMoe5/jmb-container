...
LABEL maintainer="https://github.com/BeeMoe5"
...
LABEL org.label-schema.name="BeeMoe"
...
LABEL org.label-schema.docker.cmd="docker run -v ./config:/jmb/config -d BeeMoe/jmusicbot"
...
ADD --chmod=644 https://github.com/SeVille/MusicBot/releases/download/$VERSION/JMusicBot-$VERSION.jar /jmb/JMusicBot.jar
